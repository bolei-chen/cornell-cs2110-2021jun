...
public class Quick {
    ...
    /**
     * Rearranges the array so that a[k] contains the kth smallest key; a[0] through
     * a[k-1] are less than (or equal to) a[k]; and a[k+1] through a[N-1] are
     * greater than (or equal to) a[k].
     * 
     * @param a the array
